...
# Basics of spatial and spatiotemporal data
...
hamilton_habitat_desc <- readRDS("ExemplePathTohamilton_habitat.rds")
```
...
# Because, the data contains replicates, we want to average the measurement of
# Total Phosphorus by year and site.
