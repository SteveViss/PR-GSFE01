...
Based on what you have learned about inverse distance wieghting and `gstat` find a way to account for time in making an interpolation.
...
1. Find the best value of $c$ using K-fold cross validation by changing the value of $c$ by increments of 0.1. 
