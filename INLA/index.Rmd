...
Actually, knowing about *Gaussian Markov Random Fields* is technically important for the basic INLA algorithm but we can skimmed over it earlier, however now we need to look into it in more details.
...
# .small[Gaussian Markov Random Field in space]
