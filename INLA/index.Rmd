...
```{r, echo = FALSE, fig.width=12, eval = FALSE}
...
mtext("Semivariance", side = 2, cex = 2, outer = TRUE)
...
The reason why the Matérn covariance model is interesting to use is that it has wave spectrum that can be defined through the Bessel function used in its construction

## Bessel function of the second kind
```{r echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Bessel_Functions_%282nd_Kind%2C_n%3D0%2C1%2C2%29.svg/300px-Bessel_Functions_%282nd_Kind%2C_n%3D0%2C1%2C2%29.svg.png")
```
...
With the Matérn covariance model the difference between the classical approach can be seen visually
