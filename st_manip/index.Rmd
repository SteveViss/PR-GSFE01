...
**Note**: each row corresponds to a sample taken at a specific location and at particular time point.
...
We can obtain the previously shown data structure with a few manipulation of `sf` object.

## Manipulation de code ici
## Manipulation de code ici
## Manipulation de code ici
