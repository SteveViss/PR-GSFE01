...
https://steveviss.github.io/PR-GSFE01/trend_surface/index.html

## `r icon::fa("tag")` Practical:
https://steveviss.github.io/PR-GSFE01/trend_surface/practice.html
...
- Be a purely spatial or temporal construction (e.g. xy-coordinates)
- Be a purely temporal construction (e.g. day of the year)

[Painting Species distribution model paper](paper/Fourcade_et_al_2018.pdf)
...
```{r, echo = FALSE, fig.align='center', fig.width=12, fig.retina = 2}
par(mfrow = c(2,2))
...
knitr::include_graphics("assets/img/Friedman_Stuetzle.png")
```

In the paper published in 1981 in the Journal of the American Statistical Association

```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("assets/img/Additive_model_paper.png")
```
...
knitr::include_graphics("assets/img/Hastie_Tibshirani.png")
```
]
...
knitr::include_graphics("assets/img/GAM_book_TH.jpeg")
```
]
...
knitr::include_graphics("assets/img/grinning-face-with-one-large-and-one-small-eye_1f92a.png")
```
...
The polynomial base function is one of many base function used in generalized additive models, sadly it is actually not very good.

Ones more commonly used is the cubic regression splines

```{r echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics("assets/img/cubic_spline.png")
```
...
# Principal of permutation testing
## .footnotesize[Continuing the example of the Pearson's correlation] $(r)$
...
# Principal of permutation testing
## .footnotesize[Continuing the example of the Pearson's correlation] $(r)$
### Illustration of one-tailed test, left tail results
...
# Study case: Species distribution models 

## `r icon::fa("tag")` with GLM:
https://steveviss.github.io/PR-GSFE01/trend_surface/practiceGLM.html

## `r icon::fa("tag")` with GAM:
https://steveviss.github.io/PR-GSFE01/trend_surface/practiceGAM.html
