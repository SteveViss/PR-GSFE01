---
title: "Species distribution model with GLM"
...
1. [Birds data](assets/data/birdAll.rds)
2. [Climate](assets/data/climate_Present.rds)
3. [Roads](assets/data/road_Distance.rds)

```{r}
birds <- readRDS("assets/data/birdAll.rds")
